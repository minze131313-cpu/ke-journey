...
export const places: Place[] = [
  ...
  { id:"riyue", name:"日月山", day:2, coords:[100.9822,36.4467], category:"scenic", region:"青海 · 湟源", subtitle:"进入青藏高原的第一道门户", altitude:"约3,520m", visit:"1小时", description:"唐蕃古道的重要垭口，也是环线首次明显升高海拔的位置。", tips:["停留以短时观景为主","大风时注意保暖","不要在公路弯道临停"] , staySearch:"西宁", stayPlaceType:"城市"},
  { id:"qinghai", name:"青海湖二郎剑", day:2, coords:[100.4927,36.5819], category:"scenic", region:"青海 · 海南州", subtitle:"高原湖泊与草原景观核心", altitude:"约3,200m", visit:"2—3小时", booking:"走正规景区通道", description:"从官方开放区域亲近青海湖，避免翻越围栏进入保护区或私人草场。", tips:["旺季提前购票","只在正规停车区停车","湖边紫外线和风力都很强"] , staySearch:"青海湖", stayPlaceType:"景点"},
  { id:"chaka", name:"茶卡盐湖", day:3, coords:[99.0767,36.6906], category:"scenic", region:"青海 · 乌兰", subtitle:"天空之镜与盐湖铁路", altitude:"约3,059m", visit:"3小时", booking:"建议提前购票", description:"上午光线柔和、风相对较小；天气和风速决定倒影效果。", tips:["准备鞋套或可清洗鞋","阴雨天气减少盐湖停留","前一晚住茶卡镇便于早入园"] , staySearch:"乌兰", stayPlaceType:"城市"},
  ...
  { id:"emerald", name:"大柴旦翡翠湖", day:4, coords:[95.2062,37.8395], category:"scenic", region:"青海 · 大柴旦", subtitle:"多色盐池与雪山倒影", altitude:"约3,140m", visit:"2—3小时", booking:"旺季建议预约", description:"不同矿物浓度形成蓝绿相间的盐池，傍晚侧光更有层次。", tips:["景区内按指定线路活动","无人机须遵守现场规定","盐壳薄弱处不可进入"] , staySearch:"大柴旦行委", stayPlaceType:"城市"},
  { id:"daqaidam", name:"大柴旦镇", day:4, coords:[95.3565,37.8527], category:"supply", region:"青海 · 海西州", subtitle:"进入G315前的关键基地", altitude:"约3,170m", visit:"住宿补给", description:"水上雅丹往返与敦煌方向的核心住宿点，旺季房源紧张。", tips:["到达即补满油","检查胎压和备胎","次日天亮出发避免夜驾"] , staySearch:"大柴旦行委", stayPlaceType:"城市"},
  ...
  { id:"yadan", name:"乌素特水上雅丹", day:5, coords:[93.0815,37.2759], category:"scenic", region:"青海 · 海西州", subtitle:"湖泊中的雅丹地貌群", altitude:"约2,680m", visit:"3小时", booking:"旺季提前购票", description:"本方案走G315铺装路往返大柴旦，不进入火星一号公路和俄博梁无人区。", tips:["单司机建议增加一晚","回程前确认剩余油量","不要驶入无管理土路"] , staySearch:"大柴旦行委", stayPlaceType:"城市"},
  ...
  { id:"mogao", name:"莫高窟", day:7, coords:[94.8041,40.0372], category:"scenic", region:"甘肃 · 敦煌", subtitle:"世界文化遗产与实名预约景区", visit:"约4小时", booking:"必须通过官方渠道实名预约", description:"常规票包含数字电影与实体洞窟，旺季名额有限，是整趟行程的首要预约项。", tips:["提前30分钟到数字展示中心","仅使用莫高窟参观预约网渠道","窟内禁止摄影"] , staySearch:"莫高窟", stayPlaceType:"景点"},
  { id:"mingsha", name:"鸣沙山月牙泉", day:8, coords:[94.6821,40.0871], category:"scenic", region:"甘肃 · 敦煌", subtitle:"沙漠日落与夜游体验", visit:"3—4小时", booking:"旺季建议提前购票", description:"夏季建议傍晚进入，避开正午高温，同时保留白天作为莫高窟天气缓冲。", tips:["防沙鞋套视需要准备","相机做好防沙保护","日落后按现场交通组织离场"] , staySearch:"鸣沙山月牙泉", stayPlaceType:"景点"},
  { id:"jiayuguan", name:"嘉峪关关城", day:9, coords:[98.2172,39.8014], category:"scenic", region:"甘肃 · 嘉峪关", subtitle:"河西走廊长城文化地标", altitude:"约1,600m", visit:"3小时", booking:"可提前购票", description:"从敦煌经瓜州、玉门沿G30抵达，适合下午游览后住嘉峪关或酒泉。", tips:["G30大型货车多","瓜州服务区安排休息","关城风大注意帽子和随身物品"] , staySearch:"嘉峪关", stayPlaceType:"城市"},
  { id:"danxia", name:"张掖七彩丹霞", day:10, coords:[100.0611,38.9736], category:"scenic", region:"甘肃 · 张掖", subtitle:"彩色丘陵与日落观景", visit:"3—4小时", booking:"旺季建议预约", description:"下午入园更适合观察色彩变化，雨后或侧光条件下层次更突出。", tips:["确认入园口与接驳路线","不要离开栈道进入地貌区","可住丹霞镇减少往返"] , staySearch:"张掖", stayPlaceType:"城市"},
  ...
  { id:"qilian", name:"祁连县", day:11, coords:[100.2531,38.1771], category:"city", region:"青海 · 海北州", subtitle:"祁连草原与9号公路基地", altitude:"约2,800m", visit:"住宿", description:"经G213抵达后住宿，次日走S302至峨堡，再上G0611返回西宁。", tips:["夜间温度明显下降","高峰期提前订房","次日确认岗什卡通道是否开放"] , staySearch:"祁连县", stayPlaceType:"城市"},
  { id:"chaka-stay", name:"茶卡镇住宿区", day:2, coords:[99.0878,36.6842], category:"city", region:"青海 · 茶卡镇", subtitle:"D2住宿 · 盐湖东侧镇区", altitude:"约3,050m", visit:"住宿1晚", booking:"旺季提前7—14天预订", description:"选择镇中心或茶卡盐湖入口东侧、带独立停车场和供暖的住宿，方便次日早入盐湖。", tips:["确认热水和供暖条件","优先选择可免费取消房型","晚间减少剧烈活动"] , staySearch:"乌兰", stayPlaceType:"城市"},
  { id:"daqaidam-stay", name:"大柴旦住宿区", day:4, coords:[95.3678,37.8511], category:"city", region:"青海 · 大柴旦镇", subtitle:"D4—D5住宿 · 连住2晚", altitude:"约3,170m", visit:"连续住宿2晚", booking:"环线最紧张住宿点之一", description:"建议连订两晚并选择镇中心、有院内停车和制氧设备的酒店，避免水上雅丹长途日后再换房。", tips:["确认可晚到和停车位","两晚不要拆成不同酒店","入住当日检查房间供暖"] , staySearch:"大柴旦行委", stayPlaceType:"城市"},
  { id:"jiayuguan-stay", name:"嘉峪关住宿区", day:9, coords:[98.2869,39.7737], category:"city", region:"甘肃 · 嘉峪关市", subtitle:"D9首选住宿 · 距关城较近", altitude:"约1,600m", visit:"住宿1晚", booking:"与酒泉二选一", description:"若当天重点游览嘉峪关关城，优先住嘉峪关市区，第二天直接向张掖方向上G30。", tips:["选择靠近主干道且有停车场的酒店","晚餐和补给便利","次日无需折返酒泉"] , staySearch:"嘉峪关", stayPlaceType:"城市"},
  { id:"jiuquan-stay", name:"酒泉住宿区", day:9, coords:[98.4945,39.7328], category:"city", region:"甘肃 · 酒泉市", subtitle:"D9备选住宿 · 城市配套更完整", altitude:"约1,480m", visit:"住宿1晚", booking:"与嘉峪关二选一", description:"若更看重餐饮、车辆服务和房源选择，可多行驶约半小时住酒泉市区。", tips:["适合需要车辆保养或采购时选择","避免住进无停车条件的老城小巷","次日沿G30前往张掖"] , staySearch:"酒泉", stayPlaceType:"城市"},
  { id:"danxia-stay", name:"七彩丹霞镇住宿区", day:10, coords:[100.0669,38.9788], category:"city", region:"甘肃 · 临泽", subtitle:"D10备选住宿 · 方便看日落", visit:"住宿1晚", booking:"与张掖市区二选一", description:"计划看丹霞日落时可住景区入口附近，减少夜间返回张掖市区的驾驶。", tips:["确认实际入园口和酒店位置","餐饮选择少于张掖市区","次日需经张掖方向进入肃南路线"] , staySearch:"张掖", stayPlaceType:"城市"},
  { id:"gangshika", name:"岗什卡雪峰", day:12, coords:[101.6913,37.4149], category:"scenic", region:"青海 · 门源", subtitle:"仅在开放与天气允许时远眺", altitude:"主峰5,254m", visit:"机动停留", description:"受G227施工影响，不把进入雪峰景区作为刚性任务；可在开放连接路或合法观景点远眺。", tips:["不闯施工封闭区","不进行无向导登山活动","遇雨雪立即放弃支线"] , staySearch:"祁连县", stayPlaceType:"城市"},
];
